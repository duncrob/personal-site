            ...
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <div className="col-span-6 z-10">
                    <h3 className="text-medium leading-snug text-slate-200">
                        <div>
                            <a href={experience.url} target="_blank" rel="noreferrer" aria-label={experience.position + " at " + experience.company} className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-sky-300 focus-visible:text-sky-300 group/link text-base">
